<div class="modal fade bd-example-modal-lg" id="modal_detail_transaction" tabindex="-1" role="dialog" aria-labelledby="modal_detail_transactionLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title p-l-15" id="modal_detail_transactionLabel"> <strong>Detail Invoice</strong></h5>
      ...
      <div class="modal-body">
          ...
          <div class="form-row">
              ...
              <div class="col-sm-12" align="right" id="grandtotal_" >
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-sm btn-success coeg_modal" data-dismiss="modal_coeg">OK</button>
      </div>
